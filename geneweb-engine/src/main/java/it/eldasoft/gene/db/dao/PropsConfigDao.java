...
public interface PropsConfigDao {
   ...
   */
  PropsConfig getProperty(String codiceApplicazione,String chiave) throws DataAccessException;
   ...
   * @throws DataAccessException
   */
  List getPropertiesByPrefix(String codapp, String prefix)
      throws DataAccessException;
   ...
   * @throws DataAccessException
   */
  void deleteProperties(String codiceApplicazione,String[] chiavi) throws DataAccessException;
   ...
   * @throws DataAccessException
   */
  void insertProperty(PropsConfig property) throws DataAccessException;
   ...
   * @throws DataAccessException
   */
  void updateProperty(PropsConfig property) throws DataAccessException;
