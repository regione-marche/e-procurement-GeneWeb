...
/**
 * Action che controlla l'operazione di modifica dell'associazione tra le
 * ricerche il gruppo in analisi
 * 
 * @author Luca.Giacomazzo
 */
public class SalvaRicercheGruppoAction extends AbstractActionBaseAdmin {
  ...
  public ActionForward runAction(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      RicercheGruppoForm idRicercheAssociate = (RicercheGruppoForm) form;

      this.ricercheManager.updateAssociazioneRicercheGruppo(idGruppo,
          idRicercheAssociate.getIdRicerca(),
