...
/**
 * Classe base per tutte le DispatchAction semplici del package di gestione
 * delle ricerche con modello
 * 
 * @author Francesco.DeFilippis
 */
public abstract class AbstractDispatchActionBaseGenRicercheProspetto extends
    DispatchActionBase {
