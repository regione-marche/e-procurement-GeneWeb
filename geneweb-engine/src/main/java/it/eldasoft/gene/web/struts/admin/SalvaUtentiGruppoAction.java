 ...
 */
public class SalvaUtentiGruppoAction extends AbstractActionBaseAdmin {

  /** Logger Log4J di classe */
  static Logger          logger = Logger.getLogger(SalvaUtentiGruppoAction.class);
  ...
  public ActionForward runAction(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      UtentiGruppoForm idAccountAssociati = (UtentiGruppoForm) form;

      this.accountManager.updateAssociazioneAccountGruppo(idGruppo,
