 ...
 */
public class ReportAction extends DispatchActionBaseNoOpzioni {
   ...
   */
  public ActionForward salvaReport(ActionMapping mapping, ActionForm form,
      HttpServletRequest request, HttpServletResponse response)
      throws IOException, ServletException {

    if (logger.isDebugEnabled()) logger.debug("salvaReport: inizio metodo");
    ...
    if (logger.isDebugEnabled()) logger.debug("salvaReport: fine metodo");
