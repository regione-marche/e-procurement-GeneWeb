  ...
  <TBODY>
    ...
    <TR>
      <TD class="menuazioni" valign="top">
        <gene:insert name="azioniContesto" src="/WEB-INF/pages/commons/azioniContestoLista.jsp" />
      </TD>
      ...
      <div class="contenitore-arealavoro">
				...
				<div class="titolomaschera"><gene:getString name="titoloMaschera" defaultVal='${gene:resource("label.tags.template.lista.titolo")}'/></div>
				...
				<div class="contenitore-dettaglio">
			        <!-- Corpo della lista de ridirezionare -->
			        <gene:insert name="corpo" >
			          <b><big>Qui bisogna inserire il corpo della lista !!!</big></b>
			        </gene:insert>
				</div>
...
<!-- Inserisco i javascript della pagina -->
<gene:outJavaScript/>
<!-- Insert tag lasciato per il debug -->
<gene:insert name="debug" />
</BODY>
</HTML>