<%/*
      ...
      // PAGINA CHE CONTIENE IL TEMPLATE DELLA PAGINA DI DETTAGLIO PER ENTITA 
      // SENZA TAB E SENZA MENU AZIONI LATERALE
      // (utilizzato per le pagine di wizard)
      %>
...
<TABLE class="arealayout">
	...
	<TBODY>
		...
		<TR>
			...
			<div class="titolomaschera"><tiles:insert name="titoloMaschera" /></div>

			<jsp:include page="/WEB-INF/pages/commons/balloon.jsp" />

			<div class="avanzamento-wizard"><tiles:insert name="avanzamentoWizard" /></div>
