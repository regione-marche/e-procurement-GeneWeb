...
<gene:template file="lista-template.jsp" gestisciProtezioni="true" idMaschera="TAB3-LISTA" schema="GENE">
	...
	<gene:setString name="entita" value="TAB3" />
	...
	<gene:redefineInsert name="corpo">
		...
		<table class="lista">
			<tr>
				<td>
					<gene:formLista entita="TAB3" pagesize="20" sortColumn="3;4" tableclass="datilista" 
						gestisciProtezioni="true" where="TAB3COD = '${param.cod}'" gestore="it.eldasoft.gene.tags.gestori.submit.GestoreTab3">
						
						<input type="hidden" name="cod" value="${param.cod}" />
						<input type="hidden" name="titolo" value="${param.titolo}" />
						<gene:campoLista visibile="false">
							<input type="hidden" name="desc" value="${datiRiga.TAB3_TAB3DESC}" />
						</gene:campoLista>
						...
						<gene:campoLista title="Opzioni <br><center>${titoloMenu}</center>"	width="50">
							<c:if test="${currentRow >= 0}">
								<gene:PopUp variableJs="rigaPopUpMenu${currentRow}"	onClick="chiaveRiga='${chiaveRigaJava}'">
									...
									<c:if test="${datiRiga.TAB3_TAB3MOD ne '1'}">
						...
						<gene:campoLista campo="TAB3COD" />
						<gene:campoLista campo="TAB3NORD" />
						<gene:campoLista campo="TAB3TIP" href="javascript:chiaveRiga='${chiaveRigaJava}';listaVisualizza();"/>	
						<gene:campoLista campo="TAB3DESC" gestore="it.eldasoft.gene.tags.decorators.campi.gestori.GestoreCampoNote"/>	
						<gene:campoLista campo="TAB3ARC" />
						<gene:campoLista campo="TAB3MOD" />
					</gene:formLista>
				</td>
			</tr>
			<tr>
