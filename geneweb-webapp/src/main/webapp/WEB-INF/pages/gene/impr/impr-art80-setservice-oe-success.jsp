			...
			<tr> 
				<td colspan="2">
					<table class="griglia80" padding="10 0 10 0;">
						...
						<c:forEach items="${resultSetServiceOE}" var="resultSetServiceOERiga" varStatus="hMapStatus">
							<tr>
								<td style="text-align: center;">${resultSetServiceOERiga[0]}</td>
								<td style="text-align: center;">${resultSetServiceOERiga[1]}</td>
								<td style="text-align: center;">${resultSetServiceOERiga[2]}</td>
							</tr>
						</c:forEach>
					</table>
				</td>
