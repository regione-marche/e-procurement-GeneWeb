<%/*
  ...
  // PAGINA CHE CONTIENE L'ISTANZA DELLA SOTTOPARTE DELLA PAGINA DI LISTA MODELLI
	...
	<c:if test='${!fn:contains(listaOpzioniUtenteAbilitate, "ou12#")}'>
		<tr>
			<td class="vocemenulaterale">
				<a href="javascript:modificaAssModelliGruppo('${idGruppo}');" title="Modifica associazioni" tabindex="1500">Modifica associazioni</a></td>
		</tr>
	</c:if>
		<tr>
    	<td>&nbsp;</td>
