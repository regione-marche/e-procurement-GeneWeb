...
<%@ taglib uri="http://www.eldasoft.it/genetags" prefix="gene"%>
		...
		<tr>
			<td class="vocemenulaterale"><a href="javascript:lanciaNuovoGruppo();"
				title="Modifica Gruppo">Modifica</a></td>
		</tr>	
		<tr>
    	<td>&nbsp;</td>
	  </tr>
		<tr>
    	<td class="titolomenulaterale">Gruppi</td>
	  </tr>
  	<tr>
    	<td class="vocemenulaterale"><a href="RicImprese.htm" tabindex="1500">Nuovo</a></td>
	  </tr>	  
		<tr>
			<td>&nbsp;</td>
		</tr>
