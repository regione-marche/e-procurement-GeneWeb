 ...
 */
 ...
 // UFFICI INTESTATARI ASSOCIATI ALL'UTENTE IN ANALISI
%>
...
<table class="dettaglio-tab-lista">
  <tr>
  	<td>
			<display:table name="listaUfficiIntestatariAccount" id="uffintAccountForm" defaultsort="1" class="datilista" sort="list" requestURI="ListaUfficiIntestatariAccount.do">
...
<c:if test='${gene:checkProt(pageContext, "FUNZ.VIS.MOD.GENE.USRSYS-Scheda.UFFINT.SCHEDAMOD")}' >
    ...
    <td class="comandi-dettaglio" colSpan="2">
	      <INPUT type="button" class="bottone-azione" value="Modifica associazioni" title="Modifica associazioni" onclick="javascript:modificaAssUffintAccount('<c:out value='${idAccount}' />')"> &nbsp;
	    &nbsp;
	</td>
  </tr>
</c:if>
