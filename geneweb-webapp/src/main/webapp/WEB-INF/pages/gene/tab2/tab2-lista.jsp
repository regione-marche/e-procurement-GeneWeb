...
<gene:template file="lista-template.jsp" gestisciProtezioni="true" idMaschera="TAB2-LISTA" schema="GENE">
	...
	<gene:setString name="entita" value="TAB2" />
	...
	<gene:redefineInsert name="corpo">
		...
		<table class="lista">
			<tr>
				<td>
					<gene:formLista entita="TAB2" pagesize="20" sortColumn="3;4" tableclass="datilista" 
						gestisciProtezioni="true" where="TAB2COD = '${param.cod}'" gestore="it.eldasoft.gene.tags.gestori.submit.GestoreTab2">
						
						<input type="hidden" name="cod" value="${param.cod}" />
						<input type="hidden" name="titolo" value="${param.titolo}" />
						<gene:campoLista visibile="false">
							<input type="hidden" name="desc" value="${datiRiga.TAB2_TAB2D2}" />
						</gene:campoLista>
						...
						<gene:campoLista title="Opzioni <br><center>${titoloMenu}</center>"	width="50">
							<c:if test="${currentRow >= 0}">
								<gene:PopUp variableJs="rigaPopUpMenu${currentRow}"	onClick="chiaveRiga='${chiaveRigaJava}'">
									...
									<c:if test="${datiRiga.TAB2_TAB2MOD ne '1'}">
						...
						<gene:campoLista campo="TAB2COD" />
						<gene:campoLista campo="TAB2NORD" />
						<gene:campoLista campo="TAB2TIP" href="javascript:chiaveRiga='${chiaveRigaJava}';listaVisualizza();"/>	
						<gene:campoLista campo="TAB2D1" gestore="it.eldasoft.gene.tags.decorators.campi.gestori.GestoreCampoNote"/>	
						<gene:campoLista campo="TAB2D2" gestore="it.eldasoft.gene.tags.decorators.campi.gestori.GestoreCampoNote"/>
						<gene:campoLista campo="TAB2ARC" />
						<gene:campoLista campo="TAB2MOD" />
					</gene:formLista>
				</td>
			</tr>
			<tr>
