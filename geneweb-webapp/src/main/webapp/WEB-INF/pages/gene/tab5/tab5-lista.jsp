...
<gene:template file="lista-template.jsp" gestisciProtezioni="true" idMaschera="TAB5-LISTA" schema="GENE">
	...
	<gene:setString name="entita" value="TAB5" />
	...
	<gene:redefineInsert name="corpo">
		...
		<table class="lista">
			<tr>
				<td>
					<gene:formLista entita="TAB5" pagesize="20" sortColumn="3;4" tableclass="datilista" 
						gestisciProtezioni="true" where="TAB5COD = '${param.cod}'">
						...
						<gene:campoLista title="Opzioni <br><center>${titoloMenu}</center>"	width="50">
							<c:if test="${currentRow >= 0}">
								<gene:PopUp variableJs="rigaPopUpMenu${currentRow}"	onClick="chiaveRiga='${chiaveRigaJava}'">
									...
									<c:if test="${datiRiga.TAB5_TAB5MOD ne '1'}">
						...
						<gene:campoLista campo="TAB5COD" />
						<gene:campoLista campo="TAB5NORD" />
						<gene:campoLista campo="TAB5TIP" href="javascript:chiaveRiga='${chiaveRigaJava}';listaVisualizza();"/>	
						<gene:campoLista campo="TAB5DESC" gestore="it.eldasoft.gene.tags.decorators.campi.gestori.GestoreCampoNote"/>	
						<gene:campoLista campo="TAB5ARC" />
						<gene:campoLista campo="TAB5MOD" />
					</gene:formLista>
				</td>
			</tr>
			<tr>
