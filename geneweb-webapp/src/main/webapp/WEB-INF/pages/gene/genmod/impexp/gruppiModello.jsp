...
<html:form action="/GruppiModelloImport" >
	<table class="lista">
		<tr>
			<td>
				<b>Pubblicazione gruppi</b>
				<span class="info-wizard">
					E' possibile fin da subito pubblicare il modello ai gruppi di utenti; basta spuntare le righe dei gruppi ai quali si vuole rendere disponibile l'utilizzo del modello.<br>
					Premere "&lt; Indietro" per tornare alla pagina precedente, "Fine" per confermare.
				</span>
			</td>
		</tr>
		<tr>
			<td>
				<display:table name="${listaGruppiModelli}" id="gruppoForm" class="datilista" >
