<%/*
      ...
      // PAGINA CHE CONTIENE L'ISTANZA DELLA SOTTOPARTE DELLA PAGINA TROVA MODELLI
...
<gene:template file="menuAzioni-template.jsp">
	...
	<gene:insert name="addHistory">
		<gene:historyAdd titolo='Ricerca modelli' id="ricerca" />
	</gene:insert>
</gene:template>
		...
		<tr>
			<td class="vocemenulaterale">
				<a href="javascript:avviaModelloRic();" title="Trova modelli" tabindex="1500">Trova</a></td>
		</tr>	
		<tr>
			<td class="vocemenulaterale">
		...
		<!-- tr>
			<td class="vocemenulaterale">
				<a href="javascript:apriTrovaModelli();" title="Ripristino dei campi di ricerca" tabindex="1502">Annulla</a></td>
		</tr-->	
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td class="titolomenulaterale" title="Amministazione modelli">Gestione Modelli</td>
		</tr>
		<!--tr>
			<td class="vocemenulaterale">
