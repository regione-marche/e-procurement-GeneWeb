...
<html:form action="/UploadDefinizioneModello"  method="post" enctype="multipart/form-data" >
		...
		<tr>
			<td colspan="2">
				...
				<span class="info-wizard">
		   		Selezionare il file XML contenente la definizione del modello da importare.<br>
