...
<gene:formScheda entita="TEIM" gestisciProtezioni="true" gestore="it.eldasoft.gene.web.struts.tags.gestori.GestoreTEIM" >
	<gene:gruppoCampi idProtezioni="GEN" >
		...
		<gene:campoScheda campo="NOMTIM" obbligatorio="true">
	...
	<jsp:include page="/WEB-INF/pages/gene/attributi/sezione-attributi-generici.jsp">
		<jsp:param name="entitaParent" value="TEIM"/>
	</jsp:include>	
