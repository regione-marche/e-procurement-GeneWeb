...
<gene:formScheda entita="TECNI" gestisciProtezioni="true" gestore="it.eldasoft.gene.web.struts.tags.gestori.GestoreTECNI">
	<gene:gruppoCampi idProtezioni="GEN"  >
		...
		<gene:campoScheda campo="NOMTEC"  obbligatorio="true">
