<%/*
  ...
  // DELLA PAGINA DI VISUALIZZAZIONE DELLA LISTA PARAMETRI DI UNA RICERCA 
%>
	...
	<gene:insert name="addHistory">
		...
		<tr>
			<td class="vocemenulaterale">
				<a href="javascript:addParametro();" tabindex="1501" title="Aggiungi un parametro">Aggiungi parametro</a>
			</td>
		</tr>
		</c:if>
