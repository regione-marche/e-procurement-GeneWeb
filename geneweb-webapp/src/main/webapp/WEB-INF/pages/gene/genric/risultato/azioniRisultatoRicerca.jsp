	...
	<c:if test="${requestScope.risultatoRicerca.genModelli}">
		<tr>
			<td class="vocemenulaterale">
				<a href="javascript:apriPopupGenModelli();" title="Modelli predisposti" tabindex="1515">Modelli predisposti</a></td>
		</tr>
	</c:if>
</c:if>
		<tr>
			<td class="vocemenulaterale">
				<a href="javascript:stampa();" title="Anteprima di stampa dei dati estratti" tabindex="1516">Anteprima di stampa</a></td>
		</tr>
		<tr>
