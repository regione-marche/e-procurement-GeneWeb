...
<c:if test='${fn:contains(listaOpzioniDisponibili, "OP2#") && (fn:contains(listaOpzioniUtenteAbilitate, "ou48#") || (fn:contains(listaOpzioniUtenteAbilitate, "ou49#") && fn:contains(listaOpzioniUtenteAbilitate, "ou54#")))}'>	
		<tr>
			<td width="8%" align="right" valign="top">
...
<c:if test='${fn:contains(listaOpzioniDisponibili, "OP98#") && fn:contains(listaOpzioniUtenteAbilitate, "ou48#")}'>			
		<tr>
			<td width="8%" align="right" valign="top">
				<input type="radio" name="azione" id="azione" value="4" />
				<% //il valore 4 corrisponde al codice del tabellato associato al report sql %>
			</td>
			<td class="valore-dato">
				<p>
					<b>Report SQL</b>
				...
				<p>
					Questa modalit&agrave; consente di produrre report a partire dal SQL e dai parametri necessari.
  ...
  <c:if test='${! empty listaRicerchePredefinite}'>
		<tr>
			<td width="8%" align="right" valign="top">
				<input type="radio" name="azione" id="azione" value="3" />
				<% //il valore 2 corrisponde al codice del tabellato associato al report con modello %>
			</td>
			<td class="valore-dato">
				<p>
					<b>A partire da un report predefinito</b>
				</p>
				<p>
					Questa modalit&agrave; consente di produrre un report personale a partire da uno dei report predefiniti
					selezionabile dalla lista di seguito proposta:
				</p>
				<select id="idRicercaFamiglia" onchange="javascript:cambiaRadio();">
					<option value=""/>
					<c:forEach items="${listaRicerchePredefinite}" var="ricercaGruppo">
						<option value="${ricercaGruppo.idRicerca}">${ricercaGruppo.nomeRicerca}</option>
					</c:forEach>
				</select>
			</td>
		</tr>		
