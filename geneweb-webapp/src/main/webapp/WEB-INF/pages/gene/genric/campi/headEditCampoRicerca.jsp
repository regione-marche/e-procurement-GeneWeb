<%/*
  ...
  // DELLA PAGINA DI MODIFICA DI UN CAMPO APPARTENENTE AD UNA RICERCA
%>
...
<!-- 
	...
	function gestisciSubmit(){
		var esito = true;
		if (esito && !controllaCampoInputObbligatorio(document.campoRicercaForm.mnemonicoCampo, 'Campo')){
			esito = false;
		}
		if (esito){
