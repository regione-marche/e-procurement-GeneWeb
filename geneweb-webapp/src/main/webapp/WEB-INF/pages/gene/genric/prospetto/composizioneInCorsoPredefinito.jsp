<%/*
  ...
  // GENERAZIONE DEL PROSPETTO ASSOCIATO AD UNA RICERCA PREDEFINITA CON PROSPETTO
%>
...
<form action="${contextPath}/geneGenric/ComponiProspettoPredefinito.do" method="post" name="parametriProspettoForm">
