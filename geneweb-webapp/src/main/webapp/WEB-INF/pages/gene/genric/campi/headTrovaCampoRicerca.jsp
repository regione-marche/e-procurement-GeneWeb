...
<!--
  ...
  function gestisciSubmit() {
    if (document.campoRicercaForm.mnemonicoCampo.value.length == 0 && 
        document.campoRicercaForm.descrizioneCampo.value.length == 0)
        alert('Inserire almeno uno dei possibili filtri');
    else
