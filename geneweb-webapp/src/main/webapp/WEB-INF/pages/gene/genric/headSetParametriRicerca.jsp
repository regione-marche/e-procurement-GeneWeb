<%/*
  ...
  // DELLA PAGINA DI SETTING DEI PARAMETRI DI UNA RICERCA IN FASE DI ESTRAZIONE DELLA 
  // RICERCA STESSA (DURANTE LA CREAZIONE/MODIFICA DELLA RICERCA DALL'AREA 
  // APPLICATIVA 'GENERATORE RICERCHE').
%>
