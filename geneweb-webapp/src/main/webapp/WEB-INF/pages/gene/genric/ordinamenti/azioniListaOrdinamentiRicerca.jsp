<%/*
  ...
  // DELLA PAGINA DI VISUALIZZAZIONE DELLA LISTA ORDINAMENTI DI UNA RICERCA 
%>
...
<c:set var="titoloHistory" value=" - ${nomeOggetto}"/>
	...
	<gene:insert name="addHistory">
		...
		<tr>
			<td class="titolomenulaterale">Report: Azioni</td>
		</tr>
		<tr>
			<td class="vocemenulaterale">
				<a href="javascript:aggiungiOrdinamento();" tabindex="1501" title="Aggiungi ordinamento">Aggiungi ordinamento</a>
			</td>
		</tr>	
		<tr>
			<td class="vocemenulaterale">
		...
		<tr>
			<td class="vocemenulaterale">
				<a href="javascript:ripristinaRicercaSalvata();" tabindex="1503" title="Annulla la modifica e ricarica il report dalla banca dati">Annulla modifica</a>
			</td>
		</tr>		
		</c:if>
		<c:if test="${empty (sessionScope.recordDettRicerca.testata.id)}">
	  ...
	  <tr>
    	<td class="vocemenulaterale">
	    	<a href="javascript:listaRicerche();" tabindex="1510" title="Vai a lista report">Lista</a>
    	</td>
	  </tr-->
		<tr>
			<td class="vocemenulaterale">
