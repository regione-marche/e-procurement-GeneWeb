...
<html:form action="/ListaOrdinamentiRicercaBase">
		...
		<tr>
			<td>
				<display:table name="elencoOrdinamenti" class="datilista" id="ordinamento">
					...
					<!--display:column title="Tabella" -->${fn:substringAfter(ordinamento.aliasTabella, "_")}<!--/display:column-->
					<display:column title="Campo">${fn:substringAfter(ordinamento.mnemonicoCampo, "_")}</display:column>
