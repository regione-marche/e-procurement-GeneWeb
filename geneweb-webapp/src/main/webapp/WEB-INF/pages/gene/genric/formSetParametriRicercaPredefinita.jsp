...
<html:form action="/SalvaParametriRicercaPredefinita" >
	<table class="ricerca">	
	...
	<c:forEach items="${listaParametri}" var="parametro" varStatus="ciclo">
      ...
      <td class="valore-dato">
	    ...
	    <td class="comandi-dettaglio" colSpan="2">
	    	...
	    	<html:hidden property="metodo" value="salvaParametriRicercaPredefinita" />
	      <INPUT type="button" class="bottone-azione" value="Esegui report" title="Esegui report" onclick="javascript:eseguiRicerca();" >
	      <INPUT type="button" class="bottone-azione" value="Reimposta" title="Reimposta" onclick="javascript:svuotaInput();" >
	      <INPUT type="button" class="bottone-azione" value="Torna a lista" title="Torna a lista" onclick="javascript:annulla();">
	      &nbsp;
	    </td>
	  </tr>
	</table>
