<%/*
  ...
  // DI CONTESTO PER LA DEFINIZIONE DI UN NUOVO ORDINAMENTO DA AGGIUNGERE ALLA RICERCA
%>
...
%>
		...
		<tr>
			<td class="vocemenulaterale">
				<a href="javascript:annullaModifica();" tabindex="1502" title="Annulla">Annulla</a>
			</td>
		</tr>	
	  <tr>
	  	<td>&nbsp;</td>
