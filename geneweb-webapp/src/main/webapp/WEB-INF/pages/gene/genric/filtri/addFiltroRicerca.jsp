 ...
 */
 ...
 // PER LA CREAZIONE DI UIN NUOVO FILTRO DA AGGIIUNGERE AD UNA RICERCA
%>
...
<html:form action="/SalvaFiltroRicerca" >
    ...
    <tr id="valore">
      ...
      <td class="valore-dato">
      	...
      	<span id="popupHelpListaValori"><a id="jsPopUpHELPLISTAVALORITABELLATO" href="javascript:helpListaValoriTabellato();" ><IMG src="${pageContext.request.contextPath}/img/opzioni_info.gif" title="" alt="" height="16" width="16"></a></span>
      </td>
    </tr>
    <tr id="parametro">
      ...
      <td class="valore-dato">
          ...
          <c:forEach items="${listaParametriConfronto}" var="parametroForm">
          <c:choose>
          	...
          	<option value="${parametroForm.codiceParametro}">${parametroForm.codiceParametro} (${tipoPar})</option>
          </c:forEach>
        </html:select>
      </td>
    </tr>
