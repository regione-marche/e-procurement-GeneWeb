 ...
 */
 ...
 // PER LA CREAZIONE DI UIN NUOVO ORDINAMENTO DA AGGIIUNGERE AD UNA RICERCA
%>
...
<html:form action="/SalvaOrdinamentoRicerca" >
	<table class="dettaglio-tab">
      ...
      <td class="valore-dato">
        <html:select property="aliasTabella" onchange="javascript:aggiornaOpzioniSelectCampo(document.ordinamentoRicercaForm.aliasTabella.selectedIndex);">
    ...
    <tr>
      ...
      <td class="valore-dato"> 
      	<html:select property="descrizioneCampo" onchange="javascript:aggiornaCampiInput(document.ordinamentoRicercaForm.aliasTabella.selectedIndex, document.ordinamentoRicercaForm.descrizioneCampo.selectedIndex);">
          <html:option value="">&nbsp;</html:option>
        </html:select>
      </td>
    </tr>
