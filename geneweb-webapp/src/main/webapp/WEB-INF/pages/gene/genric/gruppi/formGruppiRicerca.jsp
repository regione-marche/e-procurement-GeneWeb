...
<html:form action="/SalvaGruppiRicerca" >
	<table class="dettaglio-tab-lista">
		<tr>
			<td>
				<display:table name="listaGruppiRicerca" id="gruppoForm" class="datilista" defaultsort="2" requestURI="EditGruppiRicerca.do">
					...
					<display:column property="descrGruppo" title="Descrizione" sortable="true" headerClass="sortable" />
				</display:table>
			</td>
		</tr>
		<tr>
