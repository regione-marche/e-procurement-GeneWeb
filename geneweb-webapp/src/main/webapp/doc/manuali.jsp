...
<table class="elencoManuali">
	...
	<%
	//inizio riga per manuale Navigazione
	%>
	<tr id="rowManualeUso">
		<td>
			<b><a class="link-generico" href="javascript:apriManuale('${contextPath}/doc/manuale_uso.pdf');" tabindex="2020">
							Manuale d'uso</a></b><br>
				<br>
					Il documento descrive le convenzioni adottate per la struttura dell'applicazione e fornisce la guida per poter
					navigare tra le pagine e utilizzare le funzionalit&agrave; generali.
	</td>
	</tr>
	<%
	//fine riga per manuale Navigazione
	%>
